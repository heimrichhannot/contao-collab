...
$arrDca['palettes'][\HeimrichHannot\Collab\CollabConfig::OBSERVER_SUBJECT_TASK] =
	'{general_legend},subject,title;{task_legend},tasklists,taskCriteria;{cronjob_legend},cronInterval,useCronExpression,priority,invoked,invokedState;{observer_legend},observer;{expert_legend},debug,addObserverStates;{publish_legend},published;';
